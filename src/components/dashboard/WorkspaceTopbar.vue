  ...
  <header class="flex min-h-[108px] items-center justify-between gap-6 border-b border-slate-200 bg-white px-[clamp(22px,4vw,58px)] py-5 max-sm:flex-col max-sm:items-start">
    ...
    <div class="flex items-center gap-2 sm:gap-3">
      <div class="relative">
        ...
        <button v-else class="grid size-10 place-items-center rounded-xl border border-transparent bg-white text-[#17136b] hover:border-slate-200" aria-label="Open workspace search" @click="openSearch"><Search :size="18" /></button>
      </div>
