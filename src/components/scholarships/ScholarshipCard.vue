...
import { Bookmark, CalendarDays, MapPin, ArrowUpRight } from 'lucide-vue-next'
import type { Scholarship } from '../../types'
import { useAppState } from '../../composables/useAppState'
defineProps<{ scholarship: Scholarship; compact?: boolean }>()
