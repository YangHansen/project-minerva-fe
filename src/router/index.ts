...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/test-prep', component: () => import('../views/TestPrepView.vue'), meta: { title: 'Test Prep | Minerva' } },
    { path: '/interview-prep', component: () => import('../views/InterviewPrepView.vue'), meta: { title: 'Interview Prep | Minerva' } },
