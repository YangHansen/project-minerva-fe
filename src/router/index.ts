...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/forgot-password', component: () => import('../views/ForgotPasswordView.vue'), meta: { title: 'Forgot password | Minerva', auth: true } },
    { path: '/reset-password', component: () => import('../views/ResetPasswordView.vue'), meta: { title: 'Reset password | Minerva', auth: true } },
    { path: '/oauth/callback', component: () => import('../views/OAuthCallbackView.vue'), meta: { title: 'Finishing sign-in | Minerva' } },
